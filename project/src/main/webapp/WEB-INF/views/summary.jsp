                ...
                <div class="page-content flex-grow-1 overflow-auto">
                    <div class="cruise-mini-card d-flex mt-5">
                        ...
                        <div class="d-flex flex-column px-5 flex-grow-1">
                            <div>Sailing to</div>
                            <h5>
                                Dawes Glacier, Alaska | Skagway, Alaska | Juneau, Alaska | Ketchikan, Alaska</h5>
                            <span class="flex-grow-1"></span>
                            <div class="d-flex">
                                <h4>Starting from <b>$3500 CAD</b></h4>
                                <span class="flex-grow-1"></span>
                                <button type="button" class="btn" onclick="selectCruise(0)">SELECT</button>
                            </div>
                    ...
                    <div class="cruise-mini-card d-flex mt-5">
                        ...
                        <div class="d-flex flex-column px-5 flex-grow-1">
                            ...
                            <div class="d-flex">
                                <h4>Starting from <b>$3500 CAD</b></h4>
                                <span class="flex-grow-1"></span>
                                <button type="button" class="btn" onclick="selectCruise(1)">SELECT</button>
                            </div>
